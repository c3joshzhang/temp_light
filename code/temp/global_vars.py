...
PROJECT_DIR = Path(os.path.abspath(os.path.join(os.path.abspath(__file__), "..")))
...
TARGET_DT_NAMES = {
    "setcover": [
        "test_500r_1000c_0.05d",
        "transfer_1000r_2000c_0.05d",
        "transfer_2000r_4000c_0.05d",
        "transfer_4000r_8000c_0.05d",
        "transfer_8000r_16000c_0.05d",
    ],
    "cauctions": [
        "test_200_1000",
        "transfer_400_2000",
