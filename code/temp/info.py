...
class ConInfo:
    ...
    def copy(self):
        return type(self)(self.lhs_p.copy(), self.lhs_c.copy(), self.rhs.copy(), self.types.copy())
...
class ModelInfo:
    ...
    def copy(self):
        return type(self)(self.var_info.copy(), self.con_info.copy(), self.obj_info.copy())
